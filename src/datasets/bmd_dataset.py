...
class BMDDataset(Dataset):
    ...
    # v2: DINOv2 reduced from 6144 (4-layer CLS) → 1536 (last-layer CLS)
    # v2: Qwen-Omni removed (incompatible with transformers 5.5)
    # Total: 1408+2048+3072+2048+3584+5120+1536+3072 = 21888
    DEFAULT_MODALITIES = [
        ...
        "InternVL3_14B",        # 5120
        "dinov2_giant",         # 1536 (v2: CLS last layer only)
        "vlm2vec_7b",           # 3072 (v2: Phi-3.5-Vision hidden_size)
    ]
    ...
    def __init__(self, cfg, split="train"):
        ...
        # Feature directories (v2 default: normalized features)
        feature_root = Path(PROJECT_ROOT) / bmd_cfg.get(
            "feature_root", "Data/features_npy_pooled_v2"
        )
